...
It turns out that the ETS returned a model which is aligned with our expectations. Therefore, we won't train any additional models. With that, we use the best parameters in the entire dataset and forecast the demand for the next 14 days
